...
```{r full map, eval=FALSE, fig.height=12, fig.width=12, message=FALSE, warning=FALSE, include=FALSE}
 # Full map
  basemap +
...
```{r inset maps, eval=FALSE, message=FALSE, warning=FALSE, include=FALSE}
  # smaller maps
...
The unit `r unitname` is part of the environmental supergroup `r groupname`.
...
ecodatAb$f <- factor(ecodatAb$f, levels = c("continent", "env. unit", "assemblage"))
...
This supergroup is, on average, substantially higher in `r df2txt(abioticMeans, 1.25, type = "a")` than continental Antarctica. It is substantially lower in `r df2txt(abioticMeans, 0.75, type = "a")` than the rest of the continent.
