...
data %>% filter(!grepl("NA", unit_h, fixed = TRUE)) %>% separate(unit_h, into = c("group", "unit"), sep = "_") %>% ggplot(aes(x = slope, y = elevation, color = unit)) + stat_ellipse(level = 0.50, lwd = 1.5) + facet_wrap(.~group, scales = 'fixed') + theme(legend.position = c(0.8, 0.25)) 
...
data %>% filter(!grepl("NA", unit_h, fixed = TRUE)) %>% separate(unit_h, into = c("group", "unit"), sep = "_") %>% ggplot(aes(x = melt, y = totPrecip, color = unit)) + stat_ellipse(level = 0.50, lwd = 1.5) + facet_wrap(.~group, scales = 'fixed') + theme(legend.position = c(0.8, 0.25)) + scale_y_log10() + scale_x_log10()
...
```{r echo=FALSE, fig.height=7, fig.width=9, message=FALSE, warning=FALSE}
data %>% filter(!grepl("NA", unit_h, fixed = TRUE)) %>% separate(unit_h, into = c("group", "unit"), sep = "_") %>% ggplot(aes(x = solar, y = wind, color = unit)) + stat_ellipse(level = 0.50, lwd = 1.5) + facet_wrap(.~group, scales = 'fixed') + theme(legend.position = c(0.8, 0.25)) 
...
```{r echo=FALSE, fig.height=7, fig.width=9, message=FALSE, warning=FALSE}
data %>% filter(!grepl("NA", unit_h, fixed = TRUE)) %>% separate(unit_h, into = c("group", "unit"), sep = "_") %>% ggplot(aes(x = cloud, y = DDm5, color = unit)) + stat_ellipse(level = 0.50, lwd = 1.5) + facet_wrap(.~group, scales = 'fixed') + theme(legend.position = c(0.8, 0.3)) + scale_y_log10()
