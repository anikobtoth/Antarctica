...
ecodatAb %>% filter(grepl("E1", unit_h)) %>% 
...
ecodatBi %>% filter(grepl("E1", unit_h)) %>% 
...
ecodatAb %>% filter(grepl("E2", unit_h)) %>% 
  ggplot(aes(x = unit_h, y = value, fill = unit_h)) + geom_boxplot(outlier.size = 0.3) + facet_wrap(~name,    scales = "free") + scale_fill_viridis(discrete = TRUE) + theme(axis.text.x = element_blank())

ecodatBi %>% filter(grepl("E2", unit_h)) %>% 
  ggplot(aes(x = unit_h, y = value, fill = unit_h)) + geom_boxplot(outlier.size = 0.3) + facet_wrap(~taxon,    scales = "free") + scale_fill_viridis(discrete = TRUE) + theme(axis.text.x = element_blank())
...
ecodatAb %>% filter(grepl("E3", unit_h)) %>% 
  ggplot(aes(x = unit_h, y = value, fill = unit_h)) + geom_boxplot(outlier.size = 0.3) + facet_wrap(~name,    scales = "free") + scale_fill_viridis(discrete = TRUE) + theme(axis.text.x = element_blank())

ecodatBi %>% filter(grepl("E3", unit_h)) %>% 
  ggplot(aes(x = unit_h, y = value, fill = unit_h)) + geom_boxplot(outlier.size = 0.3) + facet_wrap(~taxon,    scales = "free") + scale_fill_viridis(discrete = TRUE) + theme(axis.text.x = element_blank())
...
ecodatAb %>% filter(grepl("E4", unit_h)) %>% 
  ggplot(aes(x = unit_h, y = value, fill = unit_h)) + geom_boxplot(outlier.size = 0.3) + facet_wrap(~name,    scales = "free") + scale_fill_viridis(discrete = TRUE) + theme(axis.text.x = element_blank())

ecodatBi %>% filter(grepl("E4", unit_h)) %>% 
  ggplot(aes(x = unit_h, y = value, fill = unit_h)) + geom_boxplot(outlier.size = 0.3) + facet_wrap(~taxon,    scales = "free") + scale_fill_viridis(discrete = TRUE) + theme(axis.text.x = element_blank())
...
ecodatAb %>% filter(grepl("E5", unit_h)) %>% 
  ggplot(aes(x = unit_h, y = value, fill = unit_h)) + geom_boxplot(outlier.size = 0.3) + facet_wrap(~name,    scales = "free") + scale_fill_viridis(discrete = TRUE) + theme(axis.text.x = element_blank())

ecodatBi %>% filter(grepl("E5", unit_h)) %>% 
  ggplot(aes(x = unit_h, y = value, fill = unit_h)) + geom_boxplot(outlier.size = 0.3) + facet_wrap(~taxon,    scales = "free") + scale_fill_viridis(discrete = TRUE) + theme(axis.text.x = element_blank())
...
ecodatAb %>% filter(grepl("G|L", unit_h)) %>% 
  ggplot(aes(x = unit_h, y = value, fill = unit_h)) + geom_boxplot(outlier.size = 0.3) + facet_wrap(~name,    scales = "free") + scale_fill_viridis(discrete = TRUE) + theme(axis.text.x = element_blank())

ecodatBi %>% filter(grepl("G|L", unit_h)) %>% 
  ggplot(aes(x = unit_h, y = value, fill = unit_h)) + geom_boxplot(outlier.size = 0.3) + facet_wrap(~taxon,    scales = "free") + scale_fill_viridis(discrete = TRUE) + theme(axis.text.x = element_blank())
